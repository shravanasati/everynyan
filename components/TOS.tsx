...
const sections = [
	{
		...
		content:
			"Please note that Everynyan is a platform for user-generated content. Any posts made on the platform do not represent the views or opinions of Everynyan or developers behind Everynyan. We encourage you to share your thoughts, but remember that the responsibility for the content lies with the individual users.",
	},
	{
