...
export default function BlobGradient({ className }: { className?: string }) {
  return (
    <div className={cn("flex h-screen justify-center items-center", className)}>
      <div className="blur-[150px]">
        <svg id="visual" viewBox="0 0 900 900" width="900" height="900">
          <g transform="translate(381.81376557236774 441.7683837651134)">
            <motion.path
